...
<div class="container">
  <div class="row">
    <div class="[ col-sm-6 col-md-offset-2 col-md-4 ]">
      ...
      <br/>
      <div class="[ info-card ]">
        <img style="width: 100%;" src="https://img-9gag-fun.9cache.com/photo/aGjdMRn_700bwp.webp" />
        <div class="[ info-card-details ] animate">
          ...
          <div class="[ info-card-detail ]">
            <!-- Description -->
            <p>sebagian besar pasti tentang fiksi.... gak terbatas sampai kemana.., jadi ini awalnya, banyak kesalahan, banyak gagal tapi kan namanyajuga belajar.. 🙂</p>
            <div class="social">
