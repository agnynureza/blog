...
<div class="container">
  <div class="row">
    <div class="[ col-sm-6 col-md-offset-2 col-md-4 ]">
      ...
      <br/>
      <div class="[ info-card ]">
        <img style="width: 100%;" src="../assets/me.jpg" />
        <div class="[ info-card-details ] animate">
          <div class="[ info-card-header ]">
            <h1> Agny Muchamad Nureza </h1>
          </div>
          <div class="[ info-card-detail ]">
            <!-- Description -->
            <p>sebagian besar pasti tentang fiksi.. i love fiksi so much.. gak terbatas sampai kemana.. kan semua juga belajar dari langkah pertama gak bisa langsung lari, jadi ini awalnya, banyak kesalahan, banyak gagal tapi kan namanyajuga belajar.. 🙂</p>
            <div class="social">
              ...
              <a href="#" class="[ social-icon github ] animate"><span class="fa fa-github-alt"></span></a>
